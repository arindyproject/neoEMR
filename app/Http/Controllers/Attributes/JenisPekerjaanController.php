...
class JenisPekerjaanController extends Controller
{
    public function __construct()
    {
        ...
        $this->url_index    = 'attributes.jenis.pekerjaan.index';
        $this->url_edit     = 'attributes.jenis.pekerjaan.edit';
        $this->url_store    = 'attributes.jenis.pekerjaan.store';
        $this->url_update   = 'attributes.jenis.pekerjaan.update';
        $this->url_delete   = 'attributes.jenis.pekerjaan.destroy';

        $this->title        = "ATT Jenis Pekerjaan";
        
        $this->table        = new attJenisPekerjaan;
