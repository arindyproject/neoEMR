...
class JenisPendidikanController extends Controller
{
    public function __construct()
    {
        ...
        $this->url_index    = 'attributes.jenis.pendidikan.index';
        $this->url_edit     = 'attributes.jenis.pendidikan.edit';
        $this->url_store    = 'attributes.jenis.pendidikan.store';
        $this->url_update   = 'attributes.jenis.pendidikan.update';
        $this->url_delete   = 'attributes.jenis.pendidikan.destroy';

        $this->title        = "ATT Jenis Pendidikan";
        
        $this->table        = new attJenisPendidikan;
