...

{
    public function __construct()
    {
        ...
        $this->url_index    = 'attributes.jenis.agama.index';
        $this->url_edit     = 'attributes.jenis.agama.edit';
        $this->url_store    = 'attributes.jenis.agama.store';
        $this->url_update   = 'attributes.jenis.agama.update';
        $this->url_delete   = 'attributes.jenis.agama.destroy';

        $this->title        = "ATT Jenis Agama";
        
        $this->table        = new attJenisAgama;
