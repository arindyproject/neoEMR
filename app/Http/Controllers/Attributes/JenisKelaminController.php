...
class JenisKelaminController extends Controller
{
    public function __construct()
    {
        ...
        $this->url_index    = 'attributes.jenis.kelamin.index';
        $this->url_edit     = 'attributes.jenis.kelamin.edit';
        $this->url_store    = 'attributes.jenis.kelamin.store';
        $this->url_update   = 'attributes.jenis.kelamin.update';
        $this->url_delete   = 'attributes.jenis.kelamin.destroy';

        $this->title        = "ATT Jenis Kelamin";
        
        $this->table        = new attJenisKelamin;
