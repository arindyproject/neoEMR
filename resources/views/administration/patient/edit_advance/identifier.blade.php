                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="type[]" id="type" class="form-control form-control-sm" required>
                                            <option value="" >select item...</option>
                                            @foreach ($identifier_type as $i)
                                            <option {{@$item['type']['code']['code']  ? ($item['type']['code']['code'] == $i['code'] ? 'selected' : '') : ''}}
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input value="{{@$item['system'] ? $item['system'] : '' }}" name="system[]"
                                            id="system" type="text" class="form-control form-control-sm">
                                    </div>
                                </div>
...
$(document).ready(function() {
    ...
    var html = '<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">';
        ...
        html += '<div class="col-sm-9">';
        html += '<input name="system[]" id="system" type="text" class="form-control form-control-sm" >';
        html += '</div></div>';
        //system----
