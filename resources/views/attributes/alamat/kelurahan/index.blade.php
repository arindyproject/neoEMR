            ...
            <div class="card-body">
                <form action="{{Route($url_store)}}" method="POST" class="form form-sm">
                    ...
                    <div class="form-group">
                        ...
                        <select  id="att_alamat_kotas_id" class="select2-kota form-control form-control-sm " required></select>
                    ...
                    <div class="form-group">
                        ...
                        <select name="att_alamat_kecamatans_id" id="att_alamat_kecamatans_id" class="select2-kecamatan form-control form-control-sm " required></select>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form-control-sm" name="kode_kelurahan" id="kode_kelurahan" placeholder="kode Kelurahan"  value="{{old('kode_kelurahan')}}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form-control-sm" name="nama" id="nama" placeholder="Nama Kelurahan"  value="{{old('nama')}}" required>
                        @if ($errors->has("nama"))
                            <span class="help-block">
