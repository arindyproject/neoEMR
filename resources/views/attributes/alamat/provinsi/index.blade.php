            ...
            <div class="card-body">
                <form action="{{Route($url_store)}}" method="POST" class="form form-sm">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form-control-sm" name="kode" id="kode" placeholder="kode Provinsi"  value="{{old('kode')}}">
                        @if ($errors->has("kode"))
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form-control-sm" name="nama" id="nama" placeholder="Nama Provinsi"  value="{{old('nama')}}" required>
                        @if ($errors->has("nama"))
                            <span class="help-block">
