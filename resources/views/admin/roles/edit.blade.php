    ...
    <div class="row ">
        ...
        <div class="col-xl-2 col-lg-2 col-md-3 col-sm-12">
            <div class="card">
                <div class="card-header bg-{{\App\Models\Config::get()['navbar_variants']}}">
                    <h3 class="card-title">
                        <i class="fas fa-plus-circle"></i> Edit Roles {{$data->name}}
                    </h3>
                </div>
                <div class="card-body ">
                    <form action="{{Route('admin.roles.update', $data->id)}}" method="POST" class="form">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="name" class="form-control " id="name" placeholder="name roles" required value="{{$data->name}}">
                            @if ($errors->has('name'))
                        ...
                        <div class="form-group">
                            ...
                            <select name="permissions[]" multiple="multiple" id="permissions" class="form-control select2-role-edit">
                                <option value="">---</option>
            ...
            <div class="card">
                <div class="card-header bg-{{\App\Models\Config::get()['navbar_variants']}}">
                    ...
                    <div class="card-tools">
                        <a href="{{Route('admin.roles')}}" class="btn btn-sm btn-info"><i class="fas fa-plus-circle"></i> Roles Baru</a>
                    </div>
                </div>
...
@push('scripts')
    <script>
        $(function () {
            $('.select2-role-edit').select2().val({!! $data->permissions->pluck('name') !!}).trigger('change')
        });
    </script>
@endpush
@endsection
