    ...
    <div class="row ">
        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('profile.file.update', $file->id)}}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control form-control-sm" name="is_privat" id="is_privat" required>
                                    <option {{$file->is_privat == '1' ? 'selected' : ''}} value="1">PRIVAT</option>
                                    <option {{$file->is_privat == '0' ? 'selected' : ''}} value="0">PUBLIC</option>
                                </select>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <textarea name="ket" id="ket" cols="30" rows="3" class="form-control form-control-sm">{{$file->ket}}</textarea>
                                @if ($errors->has('ket'))
                                <span class="help-block">
