    ...
    <div class="row ">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
            <div class="card">
                ...
                <div class="card-body ">
                    <form action="{{Route('post_test.update', $data->id)}}" method="POST" class="form">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <textarea rows="10" name="content" class="form-control">{{$data->content}}</textarea>
                        ...
                        <button type="submit"
                            class="btn btn-block btn-info bg-{{\App\Models\Config::get()['navbar_variants']}}">Update</button>
                    </form>
                </div>
            </div>
        </div>
